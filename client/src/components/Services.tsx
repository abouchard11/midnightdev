...
export default function Services() {
  return (
    <section
      id="services"
      className="py-16 md:py-24 border-b border-white/10 bg-background relative"
    >
      <div className="container">
        <div className="mb-12 md:mb-16 max-w-2xl">
          ...
          <p className="text-muted-foreground text-base md:text-lg">
            We operate on three distinct frequencies. Enterprise-grade software,
            local market dominance, and next-gen AI search optimization.
          </p>
        </div>
          ...
          <div className="group relative border border-white/10 bg-card hover:border-primary/50 transition-colors duration-500">
            ...
            <div className="p-8 md:p-12">
              <div className="flex justify-between items-start mb-6">
                <Badge
                  variant="outline"
                  className="rounded-none border-primary text-primary font-mono"
                >
                  ENTERPRISE
                </Badge>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Full-cycle development for scalable web applications. We build
                robust, secure, and high-performance platforms using Next.js and
                React.
              </p>
          ...
          <div className="group relative border border-white/10 bg-card hover:border-primary/50 transition-colors duration-500">
            ...
            <div className="p-8 md:p-12">
              <div className="flex justify-between items-start mb-6">
                <Badge
                  variant="outline"
                  className="rounded-none border-white/20 text-foreground font-mono"
                >
                  LOCAL_BIZ
                </Badge>
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Dominate your local market with autonomous AI agents. We
                automate SEO, lead generation, and customer engagement for
                high-LTV verticals.
              </p>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="aspect-video lg:aspect-auto w-full overflow-hidden border-b lg:border-b-0 lg:border-r border-white/10 bg-black/50 flex items-center justify-center relative">
                ...
                <div className="relative z-10 text-center space-y-2">
                  ...
                  <div className="font-mono text-xs text-primary/70 tracking-widest">
              ...
              <div className="p-8 md:p-12">
                ...
                <h3 className="text-3xl font-bold mb-4 group-hover:text-primary transition-colors">
                  ChatGPT Search Optimization (GEO)
                </h3>
                <p className="text-muted-foreground mb-8 leading-relaxed">
                  Don't just rank. Be the answer. We engineer your digital
                  presence to be the single source of truth recommended by AI
                  models like ChatGPT and Perplexity.
                </p>
