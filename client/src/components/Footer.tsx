...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="bg-background border-t border-white/10 pt-16 md:pt-24 pb-12"
    >
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 mb-16 md:mb-24">
          <div>
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-md mb-8">
              Whether you need enterprise scale or local dominance, we're ready
              to deploy.
            </p>
            ...
            <a href="mailto:contact@midnightdev.dev">
              <Button
                size="lg"
                className="w-full sm:w-auto h-16 px-8 text-lg rounded-none bg-primary hover:bg-primary/90 text-primary-foreground font-mono"
              >
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6">
            <a
              href="https://github.com/midnightdev"
              target="_blank"
            ...
            <a
              href="https://twitter.com/midnightdev"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors"
              aria-label="Twitter"
            ...
            <a
              href="https://linkedin.com/company/midnightdev"
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-primary transition-colors"
              aria-label="LinkedIn"
