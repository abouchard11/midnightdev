...
export default function AiWorkflow() {
  ...
  return (
    <div className="w-full h-[400px] border border-white/10 bg-black/50 backdrop-blur-sm relative overflow-hidden">
      ...
      {/* Console Log Output */}
      <div className="absolute bottom-4 left-4 right-4 h-24 border border-white/10 bg-black/80 p-3 font-mono text-xs overflow-hidden">
