        ...
        <section className="relative py-24 border-b border-white/10 overflow-hidden">
          ...
          <div className="container relative z-10">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Engineering logs, strategic analysis, and future-proofing
              protocols for the AI era.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {insights.map(post => (
                <Link
                  ...
                  className="group block h-full border border-white/10 bg-card hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 overflow-hidden"
                >
                  {/* Featured Image */}
