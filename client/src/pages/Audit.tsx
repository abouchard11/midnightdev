          ...
          <div className="container max-w-2xl text-center">
            ...
            >
              ...
              <p className="text-gray-400 font-mono text-lg mb-8 max-w-md mx-auto">
                Your AI Visibility Audit is being prepared. Our engineers will
                deliver your personalized report within 24 hours.
              </p>
              ...
              <a
                href="/"
                className="inline-flex items-center gap-2 bg-white text-black px-8 py-4 font-mono text-sm uppercase tracking-wider hover:bg-purple-400 transition-colors duration-300"
              >
                Return to Homepage
              </a>
            </motion.div>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Get a personalized report showing where your business appears (or
              doesn't) in ChatGPT, Perplexity, and SearchGPT — plus the 3
              highest-impact fixes to start getting recommended.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto items-start">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        A 0-100 rating of your brand's presence in Large
                        Language Models.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        See exactly how you stack up against 2-3 of your top
                        rivals in AI-generated answers.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">
                        Actionable, high-impact fixes you can implement
                        immediately to boost visibility.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-1">
                        Custom Schema Snippet
                      </h4>
                      <p className="text-muted-foreground text-sm">
                        Ready-to-deploy JSON-LD code to instantly improve your
                        entity recognition.
                      </p>
                    </div>
                  </div>
              ...
              <div className="p-6 border border-dashed border-white/20 text-center">
                <p className="text-sm font-mono text-muted-foreground">
                  "This report revealed that Perplexity didn't even know we
                  offered Enterprise plans. Fixed in 48 hours."
                </p>
            ...
            <div className="border border-white/10 bg-black p-8 relative overflow-hidden">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div className="space-y-2">
                  <label className="text-xs font-mono text-muted-foreground uppercase tracking-wider">
                    What would you most like AI to recommend you for?
                  </label>
                  <Textarea
                    ...
                    onChange={e =>
                      setFormData({
                        ...formData,
                        aiRecommendationGoal: e.target.value,
                      })
                    }
                  />
                </div>
                ...
                <p className="text-xs text-center text-muted-foreground mt-4">
                  Report generated manually by our engineers. Delivered within
                  24 hours.
                </p>
              </form>
            </div>
