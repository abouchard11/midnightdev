      ...
      >
        <div className="mb-8 flex justify-center">
          <div className="relative">
            ...
            <WifiOff className="w-24 h-24 text-purple-500 relative z-10" strokeWidth={1} />
          </div>
        </div>
        ...
        <p className="text-gray-400 mb-8 font-mono text-sm md:text-base leading-relaxed">
          The requested frequency could not be established. 
          The target coordinates may have been redacted or decomissioned.
        </p>
