...
const tiers = [
  {
    ...
    period: "one-time",
    description:
      "The diagnostic entry point. Understand your current standing and fix immediate gaps.",
    icon: Zap,
    features: [
      "AI Visibility Audit",
  ...
  },
  {
    ...
    sub: "3-month minimum",
    description:
      "Build the core infrastructure required for AI visibility and entity recognition.",
    icon: Database,
    features: [
  ...
  },
  {
    ...
    sub: "6-month minimum",
    description:
      "Aggressive authority building for competitive markets and rapid scaling.",
    icon: Network,
    features: [
  ...
  },
  {
    ...
    period: "",
    description:
      "Full-spectrum AI optimization for multi-location brands and large organizations.",
    icon: Building2,
    features: [
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              From diagnostic audits to full-scale AI authority building. Select
              the tier that matches your growth velocity.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {tiers.map((tier, index) => (
              ...
              >
                ...
                <div className="mb-8">
                  <tier.icon
                    className={`w-10 h-10 mb-6 ${tier.highlight ? "text-primary" : "text-muted-foreground group-hover:text-primary transition-colors"}`}
                  />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  We don't guess. We build. Our strategies are based on
                  reverse-engineering LLM behavior.
                </p>
              </div>
              <div>
                <h4 className="font-bold mb-2">Transparent Reporting</h4>
                <p className="text-sm text-muted-foreground">
                  No vanity metrics. We track what matters: Entity recognition,
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Traditional SEO is dying. We build infrastructure that
                  survives the AI shift.
                </p>
              </div>
            </div>
          </div>
