...
export default function AiMarketing() {
  const schema = {
    ...
    description:
      "Autonomous AI agents for local search domination, content generation, and automated lead qualification.",
    areaServed: "Global",
    hasOfferCatalog: {
      "@type": "OfferCatalog",
        ...
        <section className="relative py-24 border-b border-white/10 overflow-hidden">
          ...
          <div className="container relative z-10">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl leading-relaxed">
              Dominate your local market with an army of AI agents. We automate
              SEO, lead generation, and customer engagement so you can focus on
              closing deals.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {metrics.map(metric => (
                <div key={metric.label} className="text-center">
                  <div className="text-3xl md:text-5xl font-bold text-primary mb-2 tracking-tighter">
                    {metric.value}
                  </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  We deploy specialized AI agents that work 24/7 to grow your
                  business. They never sleep, never miss a lead, and constantly
                ...
                <div className="space-y-6">
                  {agents.map(agent => (
                    <div
                      key={agent.name}
                      className="flex items-center gap-4 p-4 border border-white/10 bg-card hover:border-primary/50 transition-colors"
                    >
        ...
        <section className="py-24 bg-primary text-primary-foreground">
          <div className="container text-center max-w-3xl">
            ...
            <p className="text-xl opacity-90 mb-8">
              Deploy your AI agent swarm today and start capturing leads while
              you sleep.
            </p>
            <ContactDialog
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="border border-white/10 p-8 hover:bg-white/5 transition-colors group">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  We optimize your Google Business Profile and website structure
                  to rank #1 for high-intent local searches.
                </p>
              </div>
              <div className="border border-white/10 p-8 hover:bg-white/5 transition-colors group">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Our agents engage leads across SMS, Email, and Social Media
                  instantly, ensuring no opportunity is lost.
                </p>
              </div>
              <div className="border border-white/10 p-8 hover:bg-white/5 transition-colors group">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Real-time analytics dashboards show you exactly what's
                  working, allowing for rapid iteration and scaling.
                </p>
              </div>
            </div>
