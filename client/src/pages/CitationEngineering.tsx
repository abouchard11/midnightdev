        ...
        <div className="container px-4 md:px-6 mb-24">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              AI models don't just guess; they verify.{" "}
              <span className="text-foreground font-semibold">
                Citation Engineering
              </span>{" "}
              systematically plants your brand in the "ground truth" datasets
              that ChatGPT, Claude, and Perplexity rely on.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative border border-white/10 bg-black/50 p-8 backdrop-blur-sm">
                ...
                <div className="space-y-6">
                  ...
                  <div className="mt-4 p-4 bg-white/5 border border-white/10 text-sm font-mono text-muted-foreground">
                    <span className="text-primary">Status:</span> Entity
                    Verified via 14 Authority Nodes.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8 order-1 lg:order-2">
              <h2 className="text-3xl md:text-4xl font-mono font-bold leading-tight">
                ...
                <br />
                IT'S ABOUT <span className="text-primary">VALIDATION</span>.
              </h2>
              <p className="text-muted-foreground text-lg leading-relaxed">
                Traditional SEO builds links to pass "juice." Citation
                Engineering builds a consistent digital footprint (NAP+W) across
                the specific databases that Large Language Models treat as
                factual sources.
              </p>
          ...
          <div className="border border-white/10 bg-white/5 p-8 md:p-12">
            <div className="text-center mb-10">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                We secure your presence on the high-authority indexes that serve
                as the training data for modern AI models.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center opacity-70">
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-[#0477FF] rounded flex items-center justify-center font-bold text-white text-lg">
                    cb
                  </div>
                  <span className="font-bold text-xl text-white group-hover:text-[#0477FF] transition-colors">
                    Crunchbase
                  </span>
                </div>
                <TooltipProvider>
                  <Tooltip>
                    ...
                    <TooltipContent className="bg-black border border-white/20 text-xs font-mono max-w-[200px]">
                      <p>
                        Domain Authority (DA) predicts how likely a website is
                        to rank in search engine results. Higher scores indicate
                        greater trust.
                      </p>
                    </TooltipContent>
                  </Tooltip>
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-[#FF3D00] rounded-full flex items-center justify-center font-bold text-white text-xs">
                    C
                  </div>
                  <span className="font-bold text-xl text-white group-hover:text-[#FF3D00] transition-colors">
                    Clutch
                  </span>
                </div>
                <TooltipProvider>
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-[#FF492C] flex items-center justify-center font-bold text-white text-lg skew-x-[-10deg]">
                    G2
                  </div>
                  <span className="font-bold text-xl text-white group-hover:text-[#FF492C] transition-colors">
                    G2 Crowd
                  </span>
                </div>
                <TooltipProvider>
              ...
              >
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-[#0A66C2] rounded flex items-center justify-center font-bold text-white text-lg">
                    in
                  </div>
                  <span className="font-bold text-xl text-white group-hover:text-[#0A66C2] transition-colors">
                    LinkedIn
                  </span>
                </div>
                <TooltipProvider>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="border border-white/10 bg-white/5 p-8 hover:border-primary/50 transition-all duration-300 group">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                We push your verified entity data (Name, Address, Phone,
                Website, Service Schema) to the core data aggregators that feed
                Bing, Google, and Apple Maps.
              </p>
            </div>
            ...
            <div className="border border-white/10 bg-white/5 p-8 hover:border-primary/50 transition-all duration-300 group">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                We identify and secure placements on the specific high-trust
                domains relevant to your industry—the ones AI models are trained
                to respect.
              </p>
            </div>
            ...
            <div className="border border-white/10 bg-white/5 p-8 hover:border-primary/50 transition-all duration-300 group">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                We monitor and manage the context of your brand mentions,
                ensuring the "sentiment vectors" associated with your name are
          ...
          <div className="border-t border-white/10 pt-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-muted-foreground">
                Stop being a "maybe" and start being a "fact."
              </p>
            </div>
            <ContactDialog
              trigger={
