...
export default function SchemaBuilder() {
  ...
  const generateSchema = () => {
    const base = {
      ...
      description:
        formData.description || "A brief description of your organization.",
      sameAs: formData.sameAs
        ? formData.sameAs.split(",").map(s => s.trim())
        : [],
    };
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mb-12 text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              AI models speak Structured Data. Use this tool to generate the
              foundational JSON-LD markup needed for ChatGPT and Perplexity to
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setFormData({ ...formData, sameAs: e.target.value })
                    }
                  />
                </div>
              </div>
            ...
            <div className="relative">
              ...
              <div className="mt-6 p-4 border border-blue-500/20 bg-blue-500/5 rounded flex gap-3 items-start">
                ...
                <div className="text-sm text-blue-200/80 leading-relaxed">
                  <strong>Installation:</strong> Copy this code and paste it
                  inside the <code>&lt;head&gt;</code> tag of your website
                  wrapped in a{" "}
